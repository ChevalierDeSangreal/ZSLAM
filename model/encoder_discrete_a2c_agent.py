...
from .encoder_ppo import EncoderA2CBuilder

"""
To modify the load_networks function in A2CBase class,
in order to register the encoder network before load function
Do not support normalize_value and normalize_input for now
"""

class EncoderDiscreteA2CAgent(a2c_common.DiscreteA2CBase):
    ...
    def load_networks(self, params):
        """
        Overwrite from A2CBase class
        """
        builder = model_builder.ModelBuilder()
        builder.network_builder.network_factory.register_builder('encoder_actor_critic', lambda **kwargs: EncoderA2CBuilder(**kwargs))
